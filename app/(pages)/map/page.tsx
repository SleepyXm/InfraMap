...
import { statusColor } from "@/app/components/types/styles";
import DeploymentsPanel from "@/app/lanes/DeploymentPanel";
import LogsPanel from "@/app/lanes/LogsPanel";
import { CostPanel } from "@/app/lanes/CostPanel";
import { TestingPanel } from "@/app/lanes/TestingPanel";
import { INITIAL_NODES, INITIAL_EDGES } from "@/app/content/mockdata";
import { NodeList } from "@/app/lanes/InfraNodes";
import { TYPE_COLORS, TYPE_LABELS, TYPE_MAP } from "@/app/components/types/type";
import { Stat } from "@/app/UI/styles/styles";
import { NodeDrawer } from "@/app/map/nodedrawer";
import { useInfraNodes } from "@/app/components/hooks/InfraNodes";
import { useWorldMap } from "@/app/components/hooks/WorldMap";
import { InfraMap } from "@/app/map/inframap";
import { useMapDims } from "@/app/components/hooks/MapDims";
    ...
    <div style={{ fontFamily: "'IBM Plex Mono', 'Courier New', monospace", background: "#080c12", color: "#c8d4e0", height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 20px", borderBottom: "1px solid #0e2033", background: "#080c12", zIndex: 10, flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 0 }}>
          <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 16, fontWeight: 800, letterSpacing: "0.12em", color: "#00e5a0", paddingRight: 20 }}>Infra<span style={{ color: "#4fc3f7" }}>Map</span></div>
          {NAV_TABS.map(tab => (
